"""
Ajio Playwright Connector
Handles Ajio price extraction using Playwright (usually blocked).
"""
...
class AjioPlaywrightConnector(BaseConnector):
    """Ajio e-commerce connector for Playwright"""
    ...
    def is_blocked_site(self) -> bool:
        return True  # Ajio usually blocks Playwright
    
    async def extract_price_playwright(self, page, url: str) -> Optional[str]:
        """Ajio usually blocks Playwright"""
