"""
Nykaa Playwright Connector
Handles Nykaa price extraction using Playwright (usually blocked).
"""
...
class NykaaPlaywrightConnector(BaseConnector):
    """Nykaa e-commerce connector for Playwright"""
    ...
    def is_blocked_site(self) -> bool:
        return True  # Nykaa usually blocks Playwright
    
    async def extract_price_playwright(self, page, url: str) -> Optional[str]:
        """Nykaa usually blocks Playwright"""
